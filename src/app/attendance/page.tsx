...
const SchoolPrintHeader = ({ title, schoolInfo, startDate, endDate }: { title: string, schoolInfo: any, startDate?: Date, endDate?: Date }) => (
    <div className="hidden print:block text-black mb-8 border-b-4 border-emerald-800 pb-4 font-kalpurush">
        <div className="flex items-center gap-6 justify-center">
            {schoolInfo.logoUrl && <img src={schoolInfo.logoUrl} alt="Logo" className="w-[70px] h-[70px] object-contain" />}
...
const MonthlyAttendanceGrid = ({ 
    ...
    useEffect(() => {
        const updateWidth = () => {
            if (tableContainerRef.current) {
                const innerTable = tableContainerRef.current.querySelector('table');
                if (innerTable) {
                    setTableScrollWidth(innerTable.scrollWidth);
                }
            }
        };
        updateWidth();
    ...
    }, [daysInMonth, students, activeDay]);
        ...
        <div className="space-y-6 animate-in fade-in duration-500 relative">
            ...
            <div className="relative group">
                <div 
                    ...
                    className="overflow-x-auto permanent-scroll no-print mb-1 h-4 bg-slate-50 border rounded"
                    style={{ width: '100%' }}
                >
...
export default function AttendancePage() {
    ...
    const sidebarItems = useMemo(() => {
        return [
            ...
            { id: 'alerts', label: 'সতর্কবার্তা', icon: Plus, color: 'text-rose-600 bg-rose-50' },
        ];
    }, []);
